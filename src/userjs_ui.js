function(){   // fake line, keep_editor_happy
    ...
    // whether to show scriptkeeper ui inside frames / iframes
    ...
    // layout of interface used in scriptkeeper's iframe
    ...
    // css used in scriptkeeper's iframe
    var style;
    function get_style()
    {
	if (style)
    ...
    {
	iframe.contentWindow.name = 'scriptkeeper_iframe';
	...
	assert(!document.querySelector('#scriptkeeper_iframe'),
	       "There are 2 scriptkeeper instances running ! Something went wrong in the extension-userjs handshake.");
	
	iframe = document.createElement('iframe');
	iframe.id = 'scriptkeeper_iframe';
 ...
 "width: 1px !important; height: 1px !important;"   +
	...
	ui_vpos + ':0px !important;' + ui_hpos + ':0px !important;';
	iframe.scrolling="no";
    ...
    {
	var zombie = document.querySelector('#scriptkeeper_iframe');
